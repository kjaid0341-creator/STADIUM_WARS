...
import { Shield, User, Mail, Lock, UserCircle2, Languages, AlertCircle, Loader, MessageSquare, Map, AlertOctagon, Share2, Facebook, Twitter, Linkedin } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0b0f19] relative overflow-hidden">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center z-10">
        ...
        {/* Right Column: Secure Register Card */}
        ...
        <div className="max-w-6xl w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-slate-400">
          ...
          <div className="flex flex-col items-center md:items-start gap-1">
            ...
            <p className="text-[10px] text-slate-500 font-semibold">
              Support Email: <a href="mailto:support@stadiumiq.app" className="hover:text-primary transition-colors text-slate-450">support@stadiumiq.app</a> • Phone: <a href="tel:+18005552026" className="hover:text-primary transition-colors text-slate-455">(800) 555-2026</a>
            </p>
          </div>
